  ...
  return (
    <>
      <div
        ...
        className={`${
          scrolled
            ? "fixed top-0 left-0 w-full z-50 bg-white text-black shadow-md"
      ...
      <div
        className={`md:hidden fixed top-24 left-1/2 w-11/12 z-50 transform -translate-x-1/2 bg-white p-5 rounded shadow-lg transition-transform duration-500 ease-in-out ${
